...
use InterService\CategoriaController;
use InterService\CursoController;

$AcaoCategoria = !empty($_POST["categoriaId"]) ? $_POST["categoriaId"] : 0;
$objCategoria = empty($objCategoria) || is_null($objCategoria) ? new CategoriaController() : $objCategoria;
?>
...
<head lang="pt-br">
  ...
  <link rel="stylesheet" href="../Arquivos Publicos/css/card.css">
...
<div class="container-fluid curso1">
  ...
  <section>
    ...
    <?php
    if($AcaoCategoria == 0)
    //Nowdoc, variaveis não vão funcionar ai dentro
    echo <<<'HTML_INFORMATIVO_CURSO'
      <div class="row pt-5">
        <div class="col-10">
...
HTML_INFORMATIVO_CURSO;
      ?>

      <div class="row pt-5">
        <h2 class="fonte2 espaco2">
          <?php switch ($AcaoCategoria) {
            //Controlo aqui qual a visão vai ser exibida antes dos botões
          case 0: //Todas as categorias
              echo "Categorias:";
            break;
          
            case 1: //técnologia
              echo 'Categoria: Tecnologia';
            break;

            case 2: //negócios
              echo 'Categoria: Negócios';
            break;
          }?>
        </h2>
      ...
      <div class="row rodape pt-3">
        ...
        <div class="col-12">
          <div class="row d-flex justify-content-center">
            ...
            <div class="col-2 d-flex justify-content-center">
              <div class="icon-awe px-1">
                <a class="link color_icone" href="construcao.html">
...
<script src="../Arquivos Publicos/js/efeitos.js" charset="utf-8"></script>
</html>