...
namespace InterService {
    require_once('interServiceDB/aulaCursoDB.class.php');
    //outras Exceptions
    use Exception;
    ...
    class AulaCurso
    {
        ...
        public function buscarAula($objAula)
        {
            ...
            try {
                ...
                $aulaDB = new AulaCursoDB("interServiceDB/DBInterservice.ini");
...
//                 $HTMLRetorno .= <<<ERRO_PADRAO
//             <h3 class="py-5 fonte2 font-weight-bold">
//               {$e->getMessage()}
//             </h3>
// ERRO_PADRAO;
            }
